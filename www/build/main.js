...
var ResentEmailPage = /** @class */ (function () {
    ...
    ResentEmailPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-resent-email',template:/*ion-inline-start:"/Users/user917916/Documents/VePorELCliente/src/pages/resent-email/resent-email.html"*/'<ion-header>\n\n  <ion-navbar>\n    <ion-title>{{ \'resent\' | translate }}</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n  <div>\n    <ion-list>\n      <ion-item>\n        <ion-label stacked>{{ \'email\' | translate }}</ion-label>\n        <ion-input type="email" [(ngModel)]="account.email" name="username" placeholder="email@email.com"></ion-input>\n      </ion-item>\n      <div padding>\n        <button ion-button color="primary" block (click)="resent_email()">{{ \'resent\' | translate }}</button>\n      </div>\n    </ion-list>\n  </div>\n</ion-content>\n'/*ion-inline-end:"/Users/user917916/Documents/VePorELCliente/src/pages/resent-email/resent-email.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_2__providers_providers__["a" /* Util */],
...
var HelpPage = /** @class */ (function () {
    ...
    HelpPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-help',template:/*ion-inline-start:"/Users/user917916/Documents/VePorELCliente/src/pages/help/help.html"*/'<ion-header>\n  <ion-navbar>\n    <img src="assets/img/logo_horizontal.png" height="40" class="center" />\n  </ion-navbar>\n</ion-header>\n<ion-content padding >\n  <h2 text-center>{{\'en_que_podriamos_ayudarte\' | translate}}</h2>\n  <ion-list>\n    <ion-item>\n      <ion-textarea [(ngModel)]="message" clearInput></ion-textarea>\n    </ion-item>\n  </ion-list>\n\n\n  <button ion-button block (click)="send()">\n  {{\'enviar\' | translate}}\n  </button>\n  <button ion-button block (click)="share()" icon-start>\n    <ion-icon name="logo-whatsapp"></ion-icon> 	&nbsp;\n    {{\'Whatsapp\' | translate}}\n  </button>\n</ion-content>\n'/*ion-inline-end:"/Users/user917916/Documents/VePorELCliente/src/pages/help/help.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_2__providers_providers__["b" /* VePorEl */],
...
var InformationPage = /** @class */ (function () {
    ...
    InformationPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-information',template:/*ion-inline-start:"/Users/user917916/Documents/VePorELCliente/src/pages/information/information.html"*/'\n<ion-header>\n  <ion-navbar>\n    <img src="assets/img/logo_horizontal.png" height="40" class="center" />\n  </ion-navbar>\n</ion-header>\n<ion-content padding="">\n<div *ngIf="option==1">\n  <h2 text-center>{{\'como_funciona_text\'| translate}}</h2>\n  <p [innerHTML]="\'como_funciona\'| translate" text-wrap text-justify></p>\n</div>\n  <div *ngIf="option==2">\n    <h2 text-center>{{\'legal_text\'| translate}}</h2>\n    <p [innerHTML]="\'info_legal\'| translate" text-wrap text-justify></p>\n  </div>\n\n\n</ion-content>\n'/*ion-inline-end:"/Users/user917916/Documents/VePorELCliente/src/pages/information/information.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */]])
    ], InformationPage);
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({template:/*ion-inline-start:"/Users/user917916/Documents/VePorELCliente/src/app/app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"/Users/user917916/Documents/VePorELCliente/src/app/app.html"*/
        }),
...
var SubcategoriesPage = /** @class */ (function () {
    ...
    SubcategoriesPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-subcategories',template:/*ion-inline-start:"/Users/user917916/Documents/VePorELCliente/src/pages/subcategories/subcategories.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle icon-only end>\n      <img src="assets/img/menu2.png" class="menu_icon" />\n    </button>\n    <img src="assets/img/logo_horizontal.png" height="40" class="center" />\n  </ion-navbar>\n</ion-header>\n<ion-content>\n  <ion-grid>\n    <ion-row>\n      <ion-col col-12>\n        <ion-slides pager>\n          <ion-slide *ngFor="let banner of banners">\n            <a href="{{banner.url_destination}}" target="_blank">\n              <img-loader src="{{util.url}}{{banner.url_photo}}" useImg fallback="assets/img/logo_horizontal.png" class="slide-image"></img-loader>\n            </a>\n          </ion-slide>\n        </ion-slides>\n      </ion-col>\n    </ion-row>\n  </ion-grid>\n  <ion-list>\n    <ion-item *ngFor="let subcategory of subcategories" (click)="get_offers(subcategory.id)">\n      <ion-thumbnail item-start>\n        <img-loader src="{{util.url}}{{subcategory.url_photo}}" useImg fallback="assets/img/logo_horizontal.png"></img-loader>\n      </ion-thumbnail>\n      <h2>{{subcategory.name}}</h2>\n    </ion-item>\n  </ion-list>\n\n</ion-content>\n'/*ion-inline-end:"/Users/user917916/Documents/VePorELCliente/src/pages/subcategories/subcategories.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_2__providers_providers__["b" /* VePorEl */],
